...
def parse_parameters(parser=None):
    ...
    #輸入全部檔案標註&標記(以索引)結果(convert_ann_using_token_idx.py的結果)
    parser.add_argument("--input_ann", default="./data/Experiments/CADEC/tokens.ann", type=str)
    ##輸入Token標記化結果(tokenization.py的結果)
    parser.add_argument("--input_tokens", default="./data/Experiments/CADEC/tokens", type=str)
    parser.add_argument("--output_filepath", default="./data/Experiments/CADEC/text-inline", type=str)
